...
# Ce script récupère les journaux d'une étape spécifique d'une exécution dans un pipeline d'Adobe Cloud Manager.
...
# Construction de l'URL de l'API pour obtenir les journaux de l'étape spécifique
api_url="https://${host_name}/api/program/${program_id}/pipeline/${pipeline_id}/execution/${execution_id}/phase/step/${step_id}/logs"
